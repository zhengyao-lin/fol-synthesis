...
theory KEYED-LIST extending LIST-BASE KEYED-HEAP INT
    ...
    relation keys: Pointer IntSet [bound(1)]

    fixpoint keys(x, h) =
        (x = nil() /\ h = empty_int_set) \/
        (key(next(x), h) /\ in_int_set(key(x), h)) \/
        (key(next(x), remove_int_set(key(x), h)))
end
...
theory BST extending KEYED-HEAP INT
...
theory ALL extending SLIST DLIST LIST SDLIST LEFTMOST end
""")


lemma_cache: Dict[str, List[Formula]] = {}
...
def main() -> None:
    # initial_lemmas: List[Formula] = [
    #     # Parser.parse_formula(theory_map["ALL"].language, r"(lseg(x:Pointer, nil()) -> list(x:Pointer))"),
    #     # Parser.parse_formula(theory_map["ALL"].language, r"(list(x:Pointer) -> lseg(x:Pointer, nil()))"),
    #     # Parser.parse_formula(theory_map["ALL"].language, r"(listlen(x:Pointer, l()) -> lseg(x:Pointer, nil()))"),
    #     # Parser.parse_formula(theory_map["ALL"].language, r"((lseg(x:Pointer, y:Pointer) /\ listlen(y:Pointer, l())) -> list(x:Pointer))"),
    #     # Parser.parse_formula(theory_map["ALL"].language, r"((lseg(nil(), x:Pointer) /\ listlen(z:Pointer, l())) -> lseg(z:Pointer, x:Pointer))"),
    #     # Parser.parse_formula(theory_map["ALL"].language, r"((listlen(x:Pointer, l()) /\ listlen(nil(), l())) -> lseg(nil(), x:Pointer))"),
    #     # Parser.parse_formula(theory_map["ALL"].language, r"((lseg(x:Pointer, y:Pointer) /\ lseg(y:Pointer, z:Pointer)) -> lseg(x:Pointer, z:Pointer))"),
    #     # Parser.parse_formula(theory_map["ALL"].language, r"((listlen(y:Pointer, l()) /\ lseg(y:Pointer, x:Pointer)) -> (list(x:Pointer) \/ lseg(nil(), x:Pointer)))"),
    #     # Parser.parse_formula(theory_map["ALL"].language, r"((list(y:Pointer) /\ lseg(y:Pointer, x:Pointer)) -> (lseg(nil(), x:Pointer) \/ list(x:Pointer)))"),
    #     # Parser.parse_formula(theory_map["ALL"].language, r"((lseg(x:Pointer, y:Pointer) /\ lseg(x:Pointer, z:Pointer)) -> (lseg(y:Pointer, z:Pointer) \/ lseg(z:Pointer, y:Pointer)))"),
    #     # Parser.parse_formula(theory_map["ALL"].language, r"(lseg(x:Pointer, nil()) -> lsegr(x:Pointer, nil()))"),
    #     # Parser.parse_formula(theory_map["ALL"].language, r"(lsegr(x:Pointer, nil()) -> lseg(x:Pointer, nil()))"),
    #     # Parser.parse_formula(theory_map["ALL"].language, r"(lsegr(nil(), x:Pointer) -> lseg(nil(), x:Pointer))"),
    #     # Parser.parse_formula(theory_map["ALL"].language, r"(lseg(nil(), x:Pointer) -> lsegr(nil(), x:Pointer))"),
    #     # Parser.parse_formula(theory_map["ALL"].language, r"(dlistlen(x:Pointer, l()) -> list(x:Pointer))"),
    #     # Parser.parse_formula(theory_map["ALL"].language, r"(dlseg(x:Pointer, nil()) -> dlist(x:Pointer))"),
    #     # Parser.parse_formula(theory_map["ALL"].language, r"(dlistlen(x:Pointer, l()) -> dlist(x:Pointer))"),
    #     # Parser.parse_formula(theory_map["ALL"].language, r"(dlseg(x:Pointer, nil()) -> list(x:Pointer))"),
    #     # Parser.parse_formula(theory_map["ALL"].language, r"(dlist(x:Pointer) -> list(x:Pointer))"),
    #     # Parser.parse_formula(theory_map["ALL"].language, r"((dlseg(x:Pointer, y:Pointer) /\ dlistlen(y:Pointer, l())) -> dlist(x:Pointer))"),
    #     # Parser.parse_formula(theory_map["ALL"].language, r"((dlseg(x:Pointer, y:Pointer) /\ dlist(y:Pointer)) -> dlist(x:Pointer))"),
    #     # Parser.parse_formula(theory_map["ALL"].language, r"((dlseg(z:Pointer, y:Pointer) /\ dlseg(x:Pointer, z:Pointer)) -> dlseg(x:Pointer, y:Pointer))"),
    #     # Parser.parse_formula(theory_map["ALL"].language, r"((dlseg(y:Pointer, x:Pointer) /\ list(x:Pointer)) -> list(y:Pointer))"),
    #     # Parser.parse_formula(theory_map["ALL"].language, r"(slistlen(y:Pointer, l()) -> slist(y:Pointer))"),
    #     # Parser.parse_formula(theory_map["ALL"].language, r"(slseg(y:Pointer, nil()) -> slist(y:Pointer))"),
    #     # Parser.parse_formula(theory_map["ALL"].language, r"(slistlen(x:Pointer, l()) -> list(x:Pointer))"),
    #     # Parser.parse_formula(theory_map["ALL"].language, r"(slseg(x:Pointer, nil()) -> list(x:Pointer))"),
    #     # Parser.parse_formula(theory_map["ALL"].language, r"(slist(x:Pointer) -> list(x:Pointer))"),
    #     # Parser.parse_formula(theory_map["ALL"].language, r"((slseg(x:Pointer, z:Pointer) /\ slseg(z:Pointer, y:Pointer)) -> slseg(x:Pointer, y:Pointer))"),
    #     # Parser.parse_formula(theory_map["ALL"].language, r"((slist(y:Pointer) /\ slseg(x:Pointer, y:Pointer)) -> list(x:Pointer))"),
    #     # Parser.parse_formula(theory_map["ALL"].language, r"((list(y:Pointer) /\ slseg(x:Pointer, y:Pointer)) -> list(x:Pointer))"),
    #     # Parser.parse_formula(theory_map["ALL"].language, r"((slistlen(y:Pointer, l()) /\ slseg(x:Pointer, y:Pointer)) -> slist(x:Pointer))"),
    #     # Parser.parse_formula(theory_map["ALL"].language, r"((slist(x:Pointer) /\ slseg(y:Pointer, x:Pointer)) -> slist(y:Pointer))"),
    #     # Parser.parse_formula(theory_map["ALL"].language, r"(bst(x:Pointer) -> btree(x:Pointer))"),
    #     # Parser.parse_formula(theory_map["ALL"].language, r"((leftmost(x:Pointer, c()) /\ bst(x:Pointer)) -> le_int(c(), key(x:Pointer)))"),
    # ]
